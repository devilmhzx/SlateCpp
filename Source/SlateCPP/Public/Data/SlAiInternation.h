 ...
 *定义本地化文本格式
 */
class SLATECPP_API SlAiInternation
{
public:
...
SlAiInternation::Register(LOCTEXT("EnterRecord", "Input Record Name!"));	//进入存档
SlAiInternation::Register(LOCTEXT("RecordNameHint", "Record Name Repeated!"));		//输入存档名
